...
clear
echo "       ****************************************************************"                      
echo "       ************************`tput setaf 7``tput sgr0``tput bold``tput setaf 26` Build OCLP-Mod`tput sgr0` `tput setaf 7``tput sgr0`************************"
echo "       ****************************************************************"
}
...
cd ~/Developer
# Clone main branch
git clone --branch main https://github.com/laobamac/OCLP-Mod.git
...
echo " "
echo "———————————————————————————————————————————————————————————————————————————————"
# Check Update OCLP-Mod main
Sleep 1
echo "[Check Update OCLP-Mod Main]"
Sleep 1
cd ~/Developer/OCLP-Mod/
if [[ -d .git ]]; then
  git fetch --all
